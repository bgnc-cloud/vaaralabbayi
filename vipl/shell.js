...
const NAV_CONFIG = [
  ...
  { group: 'Finance', items: [
    ...
    { label: '💰 Payment Receipts', href: 'receipts.html', roles: ['super_admin','accountant','auditor_team'] },
  ]},
  ...
  { group: 'Admin', items: [
    ...
    { label: '🗺️ FBC — All States', href: 'fbc-states.html', roles: ['super_admin','admin','hr_manager','investor','director_1','director_2'] },
